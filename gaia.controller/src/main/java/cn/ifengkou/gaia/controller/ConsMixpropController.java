...
public class ConsMixpropController {
    ...
    @ResponseBody
    public JsonDto getTodayDispatchList(@RequestParam(value = "productLineId",defaultValue = "")String productLineId){
    ...
    @ResponseBody
    public JsonDto getConsMixpropItem(@PathVariable("id")String id){
    ...
    @ResponseBody
    public JsonDto auditConsMixprop(@PathVariable("id")String id){
