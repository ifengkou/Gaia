package com.ark.website.filter;
...
public final class CORSFilter implements Filter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
        ...
        if (StringUtils.isNotEmpty(uri) && uri.indexOf("/druid/") != -1) {
    ...
    public void init(final FilterConfig filterConfig) throws ServletException {
        ...
        parseAndStore(DEFAULT_ALLOWED_ORIGINS, DEFAULT_ALLOWED_HTTP_METHODS, DEFAULT_ALLOWED_HTTP_HEADERS,
                DEFAULT_EXPOSED_HEADERS, DEFAULT_SUPPORTS_CREDENTIALS, DEFAULT_PREFLIGHT_MAXAGE, DEFAULT_LOGGING_ENABLED,
        ...
        if (filterConfig != null) {
            ...
            parseAndStore(configAllowedOrigins, configAllowedHttpMethods, configAllowedHttpHeaders, configExposedHeaders,
                    configSupportsCredentials, configPreflightMaxAge, configLoggingEnabled, configDecorateRequest);
        }
    }
     ...
     * @throws ServletException
     */
    public void handleNonCORS(final HttpServletRequest request, final HttpServletResponse response, final FilterChain filterChain)
    ...
    private void parseAndStore(final String allowedOrigins, final String allowedHttpMethods, final String allowedHttpHeaders,
            ...
            final String loggingEnabled, final String decorateRequest) throws ServletException {
